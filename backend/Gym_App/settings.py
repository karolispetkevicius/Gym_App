...
SECRET_KEY = 'django-insecure-39b!czrq6u=@wo+5w%3$*756-w5!l1l=7%(xls1pm^i@*uhkg3'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:8000",  # Assuming this is where your Django backend is hosted
...
# Define the URL prefix used to serve static files during production
STATIC_URL = '/static/'